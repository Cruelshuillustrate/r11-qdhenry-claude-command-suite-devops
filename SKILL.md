---
name: "r00-qdhenry-Claude-Command-Suite--devops"
description: >
  ☁️ DevOps & Cloud Infrastructure skill suite derived from qdhenry/Claude-Command-Suite.
...
```bash
# Install this skill
cp -r . ~/.claude/skills/r00-qdhenry-Claude-Command-Suite--devops/

# In Claude Code
/read ~/.claude/skills/r00-qdhenry-Claude-Command-Suite--devops/SKILL.md
```
